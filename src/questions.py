...
TABLE_OPTS = {
    ...
    "peak_rank": "Peak Rank",
    "previous_rank": "Previous Act Rank",
...
def chat_limit_question(config):
    return {
        "type": "number",
        "name": "chat_limit",
